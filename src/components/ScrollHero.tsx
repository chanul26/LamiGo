      ...
      <div className="sticky top-1/2 -translate-y-1/2 flex items-center justify-center px-6">
        <div className="relative w-full max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="relative flex items-center">
              ...
              <div className="w-full">
                ...
                <motion.h2
                  ...
                  className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight text-black absolute inset-x-0 top-0"
                >
            ...
            <div className="flex items-center justify-center">
              ...
              <motion.div
                ...
                className="w-full max-w-md rounded-2xl overflow-hidden shadow-2xl border border-black/5"
              >
                <img
          ...
          <div className="absolute left-0 right-0 bottom-[-6rem] flex justify-center">
            <div className="text-sm text-gray-500">Scroll to view the sequence →</div>
          </div>
        </div>
      </div>
    </div>
